...
/**
 * SimpleCurl - easy way to do server to server comunication using cURL.
 * 
 * ----
 * 
 ...
 * @link			https://github.com/perecedero/SimpleCurl
 */
	...
	public function call($args)
	{
		...
		*/
		...
		$default_args = array(
			...
			'return.header' => false,
			'return.body' => true,
			'parse.body' => 'auto' //auto, xml, json, json.associative, raw, false
		);
		...
		*/
		...
		if ($this->tmp_write_file == null && $args['return.body'] && $args['parse.body'] ){
			return $this->parseResponse($args['parse.body']);
		} else {
			return true;
		}
	}
