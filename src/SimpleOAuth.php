...
class SimpleOAuth
{
	 ...
	 * @access public
	 */
	public function __construct($consumerKey = null, $sharedSecret = null)
	{
		$this->credentials('client', $consumerKey, $sharedSecret);
	}
	...
	public function signature()
	{
		...
		$params = $this->parameters['oauth'] + $this->parameters['request'];
		ksort($params);
